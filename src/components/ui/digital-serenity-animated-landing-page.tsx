...
export default function DigitalSerenity() {
  ...
  // Global click for ripples (with performance considerations)
  useEffect(() => {
    const handleClick = (e: MouseEvent) => {
      // Don't ripple if clicking a link/button to avoid weird UX
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-800 text-slate-100 font-sans overflow-hidden relative">
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          ...
          <div className="text-center max-w-5xl mx-auto relative flex flex-col items-center">
            ...
            <div className="mt-12 opacity-0" style={{ animation: 'word-appear 1s ease-out forwards', animationDelay: '3s' }}>
              <Link href="/login" className="px-8 py-3 rounded-full bg-slate-100 text-slate-900 font-medium tracking-wide hover:bg-white transition-colors duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                Sign In
              </Link>
            </div>
          </div>
